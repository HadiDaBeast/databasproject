...
def get_registered_courses():
    ...
    if personnumber != None:
        ...
        render_template('index.html', current_name = student_name, Registered=result, error=error)
    return render_template('index.html', current_name = student_name, Registered=result, error="")
...
def add_student():
    ...
    if not personnumber:
        error = "Please enter a valid person number."
        return render_template('index.html', current_name = student_name, Registered=result, error=error)
