...
create procedure add_requirements (in code varchar(20), in hp int, in required varchar(32))
begin 
	declare exist int;
...
create procedure remove_requirements (in code varchar(20), in required varchar(32)) 
begin 
